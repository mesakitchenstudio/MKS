...
export function AboutClosing() {
  return (
    <section
      className="border-t border-line bg-sand/40 py-10 md:py-14"
      ...
      <div className="mx-auto grid max-w-6xl gap-6 px-4 md:grid-cols-2 md:items-center md:gap-x-12 md:px-6 lg:grid-cols-[55fr_45fr]">
        ...
        <div>
          ...
          <div className="mt-6 md:mt-8">
            <Link
              href="/recipes"
              className={`inline-flex rounded-full bg-terracotta px-6 py-3 text-sm font-semibold text-paper hover:bg-terracotta-dark ${buttonFocus}`}
            >
              Browse recipes
            </Link>
          </div>
