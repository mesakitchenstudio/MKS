...
export function RecipeCookingWorkspace(props: {
  recipe: Recipe;
  youtube?: ResolvedRecipeYoutube | null;
...
function RecipeCookingWorkspaceInner({
  recipe,
  youtube = null,
  ...
  useEffect(() => {
    if (hasVideoCtx || propChapters.length || !youtube?.videoId) return;
    let cancelled = false;
