...
export const CORE_FIELDS: FieldDefinition[] = [
  ...
  },
  {
    ...
    kind: "textarea",
    helpText:
      "Optional rich data: hook, duration, playlist, chapters, and related videos. Main video URL uses the field above.",
  },
  ...
  { key: "prepMinutes", label: "Preparation time", kind: "minutes", required: true },
  {
    ...
    label: "Baking time",
    kind: "minutes",
    helpText: "Oven time only. Use 0 when the recipe is not baked.",
  },
  {
    key: "cookMinutes",
    label: "Cooking time",
    kind: "minutes",
    helpText: "Active stovetop, grill, or pan-frying time. Use 0 when none.",
  },
  { key: "restMinutes", label: "Resting time", kind: "minutes", helpText: "Chill or rest. Use 0 if none. For bread proofing, prefer the type-specific proofing field." },
