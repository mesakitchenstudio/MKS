...
export const ADMIN_SESSION_PRESENCE_WRITE_THROTTLE_MS = 25_000;
...
export const ADMIN_STAFF_SESSIONS_POLL_MS = 20_000;

/** “Active now” when lastSeenAt is within this window (covers ~1 missed 30s heartbeat). */
export const ADMIN_SESSION_ACTIVE_NOW_MS = 90_000;
