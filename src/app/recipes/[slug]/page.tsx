...
import { RecipeStickyVideo, RecipeVideo } from "@/components/RecipeVideo";
    ...
    <article>
      ...
      <div className="mx-auto max-w-6xl px-4 py-10 md:px-6">
        <div
          className={
            hasVideo
              ? "lg:grid lg:grid-cols-[minmax(0,1fr)_18rem] lg:items-start lg:gap-x-10 xl:grid-cols-[minmax(0,1fr)_20rem]"
              : "mx-auto max-w-3xl"
          }
        >
          ...
          {hasVideo && recipe.youtubeUrl ? (
            <aside className="no-print hidden lg:block">
              <RecipeStickyVideo url={recipe.youtubeUrl} title={recipe.title} />
            </aside>
          ) : null}
        </div>
      </div>
