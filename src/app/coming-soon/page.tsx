...
export default function ComingSoonPage() {
  return (
    <>
      ...
      {/*
        min-h-dvh (not forced h-dvh + overflow lock): when the privacy note
        reserves bottom space, the page may grow and scroll naturally instead
        of overlapping Meanwhile into the body copy.
      */}
      <div className="grid min-h-dvh lg:grid-cols-[minmax(20rem,0.9fr)_1.1fr]">
        <section className="relative flex flex-col bg-paper px-7 py-9 sm:px-10 sm:py-12 md:px-14 md:py-14 lg:min-h-dvh lg:px-16 lg:py-16">
          <div>
        ...
        <section className="relative h-[min(34rem,58dvh)] w-full sm:h-[min(38rem,60dvh)] lg:min-h-dvh lg:h-full">
          <Image
            src={HERO_IMAGE}
            alt={HERO_ALT}
            fill
